...
export function Login() {
  ...
  async function handleLogin(data: Login) {
    try {
      ...
      Alert.alert(
        'Login',
        'Não foi possível logar. Verifique seu e-mail e sua senha e tente novamente.'
      );
    }
  }
      ...
      <ScrollView>
        <View>
          ...
          <TouchableOpacity
            ...
            activeOpacity={.7}
          >
            <Text className='text-violet-500 font-extrabold text-xl'>Crie uma</Text>
          </TouchableOpacity>
        </View>
        ...
        <View className='mt-11 flex-1'>
          ...
          {errors.email && (
            <Text className='text-white'>Preencha com um e-mail válido</Text>
          )}
          ...
          {errors.email && (
            <Text className='text-white'>Preencha com uma senha válida</Text>
          )}
        </View>
