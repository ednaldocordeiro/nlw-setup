...
export function HabitDay({ amount = 0, defaultCompleted = 0, date }: HabitDayProps) {
  ...
  return (
    <Popover.Root>
      <Popover.Trigger
        className={clsx('h-10 w-10 rounded-lg border-2 transition-colors focus:outline-none focus:ring-2 focus:ring-violet-800 focus:ring-offset-2 focus:ring-offset-background', {
